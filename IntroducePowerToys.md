...
# まとめ
今回は、Windowsの便利ツールPowerToysを紹介しました。これからも新機能が追加される可能性があり、より便利なツールになると思われます。FancyZoneやColor Picker
、ホストファイルエディターはエンジニアには便利な機能だと思います。OSSですので、コミッターになることもできます。ぜひ、使ってみてください。
